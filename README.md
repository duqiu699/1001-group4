...
2. 2. By obtaining that result, Taiwan Taoyuan International Airport (TPE) is chosen as our destination, departing from Hong Kong Innternational Airport (HKG).
3. 3. According to the IATA Fuel Price Analysis as followed, the jet fuel price for flights that departure from Asian areas is about US$105.68/barrel. After calculation, the fuel cost is found to be US$0.78/kg.
